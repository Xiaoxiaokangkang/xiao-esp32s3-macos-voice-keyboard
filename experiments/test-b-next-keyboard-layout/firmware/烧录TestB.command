...
script_dir="${0:A:h}"
image="$script_dir/XIAO-ESP32S3-Direct-Globe-Test-B-complete.bin"
...
echo "Test B：Consumer HID 0x029D，无 Fn Bridge。"
echo "请让 XIAO 进入下载模式："
...
echo "设备名称应显示为：XIAO Next Keyboard Layout Test B"
read -k 1 "?按任意键关闭……"
